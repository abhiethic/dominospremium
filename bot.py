...
║                                                                            ║
╠════════════════════════════════════════════════════════════════════════════╣
║   Stay connected for the best anime content and features.                  ║
║   Join our community: https://t.me/Anime_Wyvern                            ║
║                                                                            ║
╚════════════════════════════════════════════════════════════════════════════╝
"""
    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL3:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/Anime_Wyvern  for support")
                sys.exit()
